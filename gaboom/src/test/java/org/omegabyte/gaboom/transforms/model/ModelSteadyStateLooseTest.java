...
public class ModelSteadyStateLooseTest {
    ...
    @Test
    public void testModelSteadyStateLoose() {
        PCollection<KV<String, Individuals<String>>> output = input.apply(new ModelSteadyStateLoose<>(
